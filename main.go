...
func main() {
	...
	command.Flags().StringVar(&linode.Options.NodeBalancerSubnet, "nodebalancer-subnet", "", "subnet from which backend ips are assigned to nodebalancer, should be outside VPCs default subnet (e.g. 192.168.0.0/24)")
